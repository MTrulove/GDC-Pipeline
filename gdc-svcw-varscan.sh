...
#Step 3
java -jar "/home/users/industry/chicago-university/meghan/miniconda3/share/varscan-2.4.0-1/VarScan.jar" processSomatic "/home/users/industry/chicago-university/meghan/GDC-Pipeline/Varscan-Output/VS-S1.vcf.snp" --min-tumor-freq 0.10 --max-normal-freq 0.05 --p-value 0.07