#eq Co-Cleaning Command Line Parameters
#Step one - RealignTargetCreator
java -jar GenomeAnalysisTK.jar -T RealignerTargetCreator -R "/home/users/industry/chicago-university/meghan/254f697d-310d-4d7d-a27b-27fbf767a834" -known <known_indels.vcf> [ -I <input.bam> ] -o <realign_target.inervals>
